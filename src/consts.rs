...
pub const KYBER_FULL_PEM_TAG: &str = "Aloecrypt KyberFullKEM";
pub const KYBER_PUBLIC_PEM_TAG: &str = "Aloecrypt KyberPublicKEM";
pub const CIPHER_PEM_TAG: &str = "Aloecrypt Cipher";
pub const SIGNER_PEM_TAG: &str = "Aloecrypt DilithiumSigner";
pub const VERIFIER_PEM_TAG: &str = "Aloecrypt DilithiumVerifier";
pub const SIGNATURE_PEM_TAG: &str = "Aloecrypt DilithiumSignature";
...
pub const HASH_SEED_KYB_PRIVKEY: &str = "AloecryptKybPrivKey.0";
...
pub const ADDRESS_SEED_DLT_VERIFIER: &str = ADDRESS_SEED_DLT_SIGNER;
pub const ADDRESS_SEED_KYB_FULLKEM: &str = ADDRESS_SEED_DLT_SIGNER;
pub const ADDRESS_SEED_KYB_X_FULLKEM: &str = ADDRESS_SEED_DLT_SIGNER;
pub const ADDRESS_SEED_KYB_PUBKEM: &str = ADDRESS_SEED_DLT_SIGNER;
...
pub const ADDRESS_SEED_PARTY: &str = ADDRESS_SEED_DLT_SIGNER;
pub const ADDRESS_SEED_COUNTER_PARTY: &str = ADDRESS_SEED_DLT_SIGNER;
